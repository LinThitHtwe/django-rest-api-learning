...
class CustomUser(AbstractUser):
    ...
    instragram = models.URLField(max_length=255,blank=True, null=True)
...
class Blog(models.Model):
    ...
    CATEGORY =(("Tech","Tech"),("LifeStyle","LifeStyle"),("Sports","Sports"),("Food","Food"),("Travel","Travel"),("Other","Other"))
